...
{
    readonly int seed;
    readonly FilePersistenceService persistenceService;
    ...
    public ChunkGenerator(Parameters parameters, FilePersistenceService persistenceService, BlockMetadataProvider blockMetadata)
    {
    ...
    public Chunk GenerateChunk(Vec3<int> index)
    {
        ...
        {
            buffer = persistenceService.ApplyDelta(chunk, buffer);
        ...
        persistenceService.ApplyDelta(chunk, buffer);
