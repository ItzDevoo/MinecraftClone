...
public class Chunk(Vec3<int> index, BlockMetadataProvider blockMetadata) : IDisposable
{
    ...
    public FacesState GetVisibleFaces(Vec3<byte> index)
    {
        ...
        visibleFaces.ZPos = adjacentBlock.IsEmpty || blockMetadata.IsBlockTransparent(adjacentBlock);
        ...
        visibleFaces.ZNeg = adjacentBlock.IsEmpty || blockMetadata.IsBlockTransparent(adjacentBlock);
        ...
        visibleFaces.YPos = adjacentBlock.IsEmpty;
        ...
        visibleFaces.YNeg = adjacentBlock.IsEmpty;
        ...
        visibleFaces.XPos = adjacentBlock.IsEmpty;
        ...
        visibleFaces.XNeg = adjacentBlock.IsEmpty;
